...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (sizeBlock.value == '' || materialBlock.value == '') {
      resultBlock.textContent = "Пожалуйста, виберите размер и материал картинки";
...
var scrolling = function scrolling(upSelector) {
  ...
  //             smootScroll(scrollTop, hashElementTop, this.hash);
  //         }
  //     });
  // };
  // const smootScroll = (from, to, hash) => {
  //     let timeInterval = 1,
  //         prevScrollTop,
  //         speed;
  //     if (to > from) {
